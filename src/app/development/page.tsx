    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <div className={styles.left}>
          ...
          <Head text="ПЕРСОНАЛЬНАЯ" span="РАЗРАБОТКА САЙТОВ" language="" />
          <Text text="Создаю сайты с уникальным дизайном, чёткой структурой, логичным и удобным интерфейсом. А ещё у меня индивидуальный подход к каждому клиенту." />
