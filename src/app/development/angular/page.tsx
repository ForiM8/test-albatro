    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <div className={styles.left}>
          ...
          <Head text="ПЕРСОНАЛЬНАЯ" span="РАЗРАБОТКА САЙТОВ" language="НА ANGULAR" />
          <Text text="Создаю сайты НА Angular с уникальным дизайном, чёткой структурой, логичным и удобным интерфейсом. А ещё у меня индивидуальный подход к каждому клиенту." />
